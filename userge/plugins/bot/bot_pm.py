...
if userge.has_bot:
    ...
    async def start_bot(_, message: Message):
        ...
        u_n = master.username
        hello = f"""
Hello There {f_name}, I'm {bot.first_name}
I'm here to break the Game ! They call this place secure? We'll see about that.
         <i><b>Eyes in the skies , Here's my creator</i> <b>{master.first_name}</b>
"""
        ...
        try:
            await userge.bot.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("Heart Of Me", url=f"https://t.me/Broken_Memories"),
                            InlineKeyboardButton("REPO", url="https://github.com/code-rgb/USERGE-X"),
                            InlineKeyboardButton(
                                "Koony Town", url=f"https://t.me/joinchat/VZMk6-tpxT-ZT_wN"
                            ),
                        ],
                    ]
                 ),
